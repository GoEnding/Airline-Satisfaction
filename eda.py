...
def eda_st():
    ...
    sns.countplot(data=df, x='Customer Type', ax=ax)
    ...
    sns.countplot(data=df, x='Type of Travel', ax=ax)
    ...
    sns.histplot(data=df, x='Flight Distance', bins=20, kde=True, ax=ax)  # 열 이름 수정
